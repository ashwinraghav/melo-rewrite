...
export const metadata: Metadata = {
  title: 'Terms of Service — Melo',
  description: 'Melo Terms of Service',
}
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-12">
      ...
      <div className="prose-legal space-y-8 font-body text-sm leading-relaxed text-on-surface-variant">
        <p>
          Welcome to Melo. Melo is a web-based platform that delivers audio stories for young
          children. The Service is designed for use by adults — specifically parents and legal
          guardians — who may choose to share Melo content with their children under direct
          supervision.
        </p>
        <p>
          By creating an account or using Melo in any way, you agree to these Terms of Service.
        ...
        <Section title="1. Eligibility and Account Registration">
          ...
          <p>
            ...
            jurisdiction (whichever is greater), to create a Melo account and use the Service.
            Melo is not directed to children. Children may not create accounts, and no feature of
            the Service is designed for unassisted use by a child.
          </p>

          <H3>1.2 Parental and Guardian Responsibility</H3>
          <p>By using Melo, you represent and warrant that:</p>
          <ul>
            <li>You are the parent or legal guardian of any child to whom you make Melo content available;</li>
            <li>You will directly supervise your child&apos;s interaction with Melo content at all times;</li>
            ...
            <li>You understand that Melo content is generated with the assistance of artificial intelligence and that no automated system can guarantee content will be appropriate for every child at every age.</li>
          </ul>
        ...
        <Section title="3. AI-Generated Content">
          ...
          <p>
            Stories available on Melo — including text, audio narration, and cover artwork — may be
          ...
          <ul>
            ...
            <li>Melo does not and cannot guarantee that any content will be suitable, safe, or appropriate for your child or for children of any particular age;</li>
            ...
            <li>You will not rely exclusively on Melo&apos;s content filtering or age classifications as a substitute for your own parental judgment.</li>
          </ul>

          <H3>3.3 AI Disclosure</H3>
          <p>
            Stories on Melo may be generated or assisted by: large language models for story text,
        ...
        <Section title="4. Voice Cloning Feature">
          ...
          <p>
            ...
            solely for narrating stories within Melo.
          </p>
        ...
        <Section title="5. User-Created Content">
          <p>
            ...
            retain ownership of your original prompts. By generating a story, you grant Melo a
        ...
        <Section title="6. Data Collection and Privacy">
          ...
          <p>
            Melo is not a service directed to children under 13 within the meaning of the
        ...
        <Section title="7. Disclaimer of Warranties">
          ...
          <p className="font-medium text-on-surface">
            MELO DOES NOT WARRANT THAT ANY CONTENT — INCLUDING AI-GENERATED CONTENT — WILL BE
        ...
        <Section title="8. Limitation of Liability">
          <p className="font-medium text-on-surface">
            TO THE MAXIMUM EXTENT PERMITTED BY LAW, MELO SHALL NOT BE LIABLE FOR ANY INDIRECT,
            INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES ARISING FROM YOUR USE OF THE
            SERVICE, INCLUDING DAMAGES RELATED TO CONTENT CONSUMED BY YOUR CHILD, VOICE DATA, OR
            UNAUTHORIZED ACCESS TO YOUR ACCOUNT.
          </p>
          <p className="font-medium text-on-surface">
            MELO&apos;S TOTAL LIABILITY SHALL NOT EXCEED THE GREATER OF THE AMOUNT YOU PAID TO
            MELO IN THE TWELVE MONTHS PRECEDING THE CLAIM, OR ONE HUNDRED U.S. DOLLARS ($100).
          </p>
        </Section>

        <Section title="9. Indemnification">
          <p>
            You agree to indemnify and hold harmless Melo and its officers, directors, employees,
        ...
        <Section title="10. Dispute Resolution">
          <p className="font-medium text-on-surface">
            YOU AND MELO AGREE THAT ANY DISPUTE ARISING FROM THESE TERMS OR THE SERVICE SHALL BE
