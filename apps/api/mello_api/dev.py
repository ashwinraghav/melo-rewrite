...
SEED_STORIES = [
    Story(id="the-whispering-pines", title="The Whispering Pines",
          ...
          topics=["emotions"], audio_path="stories/the-whispering-pines/audio.mp3",
    ...
    Story(id="sharing-is-caring", title="Sharing is Caring",
          ...
          topics=["social"], audio_path="stories/sharing-is-caring/audio.mp3",
    ...
    Story(id="the-moons-nightcap", title="The Moon's Nightcap",
          ...
          duration_seconds=300, duration_category="short", age_min=2, age_max=6,
          topics=["safety"], audio_path="stories/the-moons-nightcap/audio.mp3",
    ...
    Story(id="rainbow-bites", title="Rainbow Bites",
          ...
          topics=["change"], audio_path="stories/rainbow-bites/audio.mp3",
    ...
    Story(id="playground-friends", title="Playground Friends",
          ...
          topics=["community", "social"], audio_path="stories/playground-friends/audio.mp3",
    ...
    Story(id="sleepy-bear", title="Sleepy Bear's Bedtime",
          ...
          topics=["change"], audio_path="stories/sleepy-bear/audio.mp3",
    ...
    Story(id="picnic-adventure", title="The Picnic Adventure",
          ...
          topics=["community", "boundaries"], audio_path="stories/picnic-adventure/audio.mp3",
